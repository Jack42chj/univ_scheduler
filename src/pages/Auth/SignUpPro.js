        ...
        <BgcolorStack>
            <Row>
                <Column sx={{ display: { xs: "none", md: "flex" }, width: "35%", minHeight: "100vh", background: `url(${ProLoginLogo})`, backgroundSize: 'cover' }}>
                    <CommonText variant="h4" sx={{ color: "#DDDDDD", px: 2 }}>강의 및 학생 관리를<br/><br/>쉽고 빠르게<br/><br/>University Scheduler</CommonText>
                </Column>
                <AuthBody>
                <IconButton href="/" sx={{ justifyContent: 'flex-start', width: "50px" }}><ArrowBackIcon fontSize="large" sx={{ color: "#FCDEC0" }} /></IconButton>
                    <CommonText variant="h5" sx={{ my: 3 }}>교수로 시작할까요?</CommonText>
