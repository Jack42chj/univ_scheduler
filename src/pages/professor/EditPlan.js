            ...
            <BgcolorBox sx={{ minHeight: "100vh", alignItems: "center" }}>
                ...
                <OuterBox sx={{ py: 5, justifyContent: "center", alignItems: "center"}}>
                    ...
                    <Row spacing={1} sx={{ justifyContent: "center", width: "80%", mt: 5 }}>
                        <TextField label="교과명" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="학정번호" variant="outlined" fullWidth defaultValue="" />
                    </Row>
                    <Row spacing={1} sx={{ justifyContent: "center", width: "80%", my: 1 }}>
                        <TextField label="년도학기" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="이수구분" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="학점" variant="outlined" fullWidth defaultValue="" />
                    </Row>
                    <Row spacing={1} sx={{ justifyContent: "center", width: "80%" }}>
                        <TextField label="강의시간" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="강의실" variant="outlined" fullWidth defaultValue="" />
                    </Row>
                    <Row spacing={1} sx={{ justifyContent: "center", width: "80%", my: 1 }}>
                        <TextField label="휴대폰" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="이메일" variant="outlined" fullWidth defaultValue="" />
                    </Row>
                    <Row spacing={1} sx={{ justifyContent: "center", width: "80%" }}>
                        <TextField label="담당교수" variant="outlined" fullWidth defaultValue="" />
                        <TextField label="담당조교" variant="outlined" fullWidth defaultValue="" />
                    </Row>
                    <TextField label="교과목 개요" variant="outlined" sx={{ width: "80%", my: 1 }} defaultValue="" />
                    <TextField label="교과목 학습 성과" variant="outlined" multiline rows={5} sx={{ width: "80%" }} defaultValue="" />
                    <TextField label="강의 운영 방식" variant="outlined" sx={{ width: "80%", my: 1 }} defaultValue="" />
                    <TextField label="교재" variant="outlined" sx={{ width: "80%" }} defaultValue="" />
                    <TextField label="평가 방법 비율" variant="outlined" sx={{ width: "80%", my: 1 }} defaultValue="" />
                    <TextField label="일정" variant="outlined" multiline rows={10} sx={{ mb: 3, width: "80%" }} defaultValue="" />
                    <Row spacing={3}>
