...
export const reference_list = (sub_id, sem_id) => {
    return axios.get(`${BASE_URL}/lecture_material/${sub_id}/${sem_id}`, sub_id, sem_id, {withCredentials:true});
};

//강의자료실 작성
export const reference_write = (sub_id, sem_id, refData) => {
    return axios.post(`${BASE_URL}/lecture_material/${sub_id}/${sem_id}/create`, sub_id, sem_id, refData);
};

//강의자료실 읽기
export const reference_read = (sub_id, sem_id, ref_id) => {
    return axios.get(`${BASE_URL}/lecture_material/${sub_id}/${sem_id}/${ref_id}`, sub_id, sem_id, ref_id, {withCredentials:true});
};

//강의자료실 수정
export const reference_update = (sub_id, sem_id, ref_id, refData) => {
    return axios.put(`${BASE_URL}/lecture_material/${sub_id}/${sem_id}/${ref_id}/update`, sub_id, sem_id, ref_id, refData);
};

//강의자료실 삭제
export const reference_delete = (sub_id, sem_id, ref_id) => {
    return axios.get(`${BASE_URL}/lecture_material/${sub_id}/${sem_id}/${ref_id}/delete`, sub_id, sem_id, ref_id, {withCredentials:true});
};
...
export const grade_list = (sub_id, sem_id) => {
    return axios.get(`${BASE_URL}/${sub_id}/${sem_id}`, sub_id, sem_id, {withCredentials:true});
};

//교수 성적 입력
export const grade_enter = (sub_id, sem_id, gradeData) => {
    return axios.post(`${BASE_URL}/${sub_id}/${sem_id}`, sub_id, sem_id, gradeData, {withCredentials:true});
};
